"""bdd_ui Repository 共用的 Test Run 与认证上下文。"""
            ...
            if self.run_id and not self.deleted:
                ...
                if result.status_code in {200, 404}:
                    ...
                    raise AssertionError(
                        f"bdd_ui Test Run 清理失败: {result.body}"
                    )
        finally:
            self.http.close()
