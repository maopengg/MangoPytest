...
class BddUIDataFactory:
    """组合实体 Factory，并记录当前场景创建的全部实体。"""

    def __init__(self, repository: BddUIRepositories):
    ...
    def create_claim(
        self, amount: int = 12000, reason: str = "AUTO_BDD_UI 前置报销"
    ) -> ClaimData:
    ...
    def create_review(
        self,
        contract_name: str = "AUTO_BDD_UI 合同",
