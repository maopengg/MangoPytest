...
@pytest.mark.parametrize("operation_case", OPERATION_GROUPS["reads"], ids=lambda case: case.case_id)
def test_read_operations(base_data, operation_case):
    apply_operation_case_metadata(operation_case, category="reads")
