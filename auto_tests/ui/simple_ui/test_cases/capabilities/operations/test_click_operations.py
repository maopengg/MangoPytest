...
@pytest.mark.parametrize("operation_case", OPERATION_GROUPS["clicks"], ids=lambda case: case.case_id)
def test_click_operations(base_data, operation_case):
    apply_operation_case_metadata(operation_case, category="clicks")
