...
@pytest.mark.parametrize("element_case", ELEMENT_GROUPS["inputs"], ids=lambda case: case.case_id)
def test_input_controls(base_data, element_case):
    apply_element_case_metadata(element_case, category="inputs")
