...
@pytest.mark.parametrize("inventory_case", INVENTORY_GROUPS["ssePage"], ids=lambda case: case.case_id)
def test_sse_elements(base_data, inventory_case):
    apply_inventory_case_metadata(inventory_case, category="ssePage")
