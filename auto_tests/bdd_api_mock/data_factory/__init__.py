...
使用示例：
    # 方式1：使用Builder
    from auto_tests.bdd_api_mock.data_factory.builders import ReimbursementBuilder
    
    builder = ReimbursementBuilder()
    entity = builder.create(user_id=1, amount=100.00)
    
    # 方式2：使用Scenario
    from auto_tests.bdd_api_mock.data_factory.scenarios import FullApprovalWorkflowScenario
