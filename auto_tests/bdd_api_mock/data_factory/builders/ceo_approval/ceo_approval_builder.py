...
class CEOApprovalBuilder(BaseBuilder[CEOApprovalEntity]):
    ...
    def get_by_id(self, approval_id: int) -> Optional[CEOApprovalEntity]:
        ...
        result = bdd_api_mock.ceo_approval.get_ceo_approval_by_id(approval_id)
    ...
    def update(self, entity: CEOApprovalEntity) -> Optional[CEOApprovalEntity]:
        ...
        result = bdd_api_mock.ceo_approval.update_ceo_approval(
    ...
    def delete(self, entity: CEOApprovalEntity) -> bool:
        ...
        result = bdd_api_mock.ceo_approval.delete_ceo_approval(entity.id)
    ...
    def get_all(self) -> List[CEOApprovalEntity]:
        ...
        result = bdd_api_mock.ceo_approval.get_ceo_approvals()
    ...
    def get_workflow(self, reimbursement_id: int) -> Optional[dict]:
        ...
        # 获取报销申请
        reimbursement_result = bdd_api_mock.reimbursement.get_reimbursement_by_id(
            reimbursement_id
        )
