...
from auto_tests.bdd_api_mock.data_factory.entities.order_pydantic import OrderEntity
...
class OrderBuilder(PydanticBuilder[OrderEntity]):
    ...
    def create_entity(self, entity: OrderEntity) -> OrderEntity:
        ...
        result = bdd_api_mock.order.create_order(**payload)
    ...
    def get_by_id(self, order_id: int) -> Optional[OrderEntity]:
        ...
        """
        result = bdd_api_mock.order.get_order(order_id)
    ...
    def get_by_user(self, user_id: int) -> List[OrderEntity]:
        ...
        """
        result = bdd_api_mock.order.get_orders_by_user(user_id)
    ...
    def pay(self, entity: OrderEntity) -> OrderEntity:
        ...
        result = bdd_api_mock.order.pay_order(entity.id)
    ...
    def cancel(self, entity: OrderEntity) -> OrderEntity:
        ...
        result = bdd_api_mock.order.cancel_order(entity.id)
    ...
    def _delete_entity(self, entity: OrderEntity) -> None:
        ...
        """
        if entity.id:
            bdd_api_mock.order.delete_order(entity.id)
