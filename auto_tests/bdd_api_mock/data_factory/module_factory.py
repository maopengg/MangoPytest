...
class ModuleDataFactory:
    ...
    def create_module_d_data(self, **kwargs) -> Dict[str, Any]:
        ...
        # 使用API管理模块创建基础数据
        from auto_tests.bdd_api_mock.api_manager.auth import AuthAPI
        from auto_tests.bdd_api_mock.api_manager.user import UserAPI
    ...
    def create_module_c_data(self, **kwargs) -> Dict[str, Any]:
        ...
        # 使用API管理模块
        from auto_tests.bdd_api_mock.api_manager.product import ProductAPI
    ...
    def create_module_b_data(self, **kwargs) -> Dict[str, Any]:
        ...
        # 使用API管理模块
        from auto_tests.bdd_api_mock.api_manager.order import OrderAPI
    ...
    def create_module_a_data(self, **kwargs) -> Dict[str, Any]:
        ...
        # 使用API管理模块
        from auto_tests.bdd_api_mock.api_manager.data import DataAPI
        from auto_tests.bdd_api_mock.api_manager.system import SystemAPI
        from auto_tests.bdd_api_mock.api_manager.file import FileAPI
