...
from auto_tests.bdd_api_mock.entities.approval.approval_log_entity import ApprovalLogEntity

__all__ = ["DeptApprovalEntity", "FinanceApprovalEntity", "CEOApprovalEntity", "ApprovalLogEntity"]
