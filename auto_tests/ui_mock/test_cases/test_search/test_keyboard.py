...
from auto_tests.ui_mock.abstract.keyboard_page import KeyboardPage
...
class TestKeyboard:
    ...
    def test_01(self, base_data):
        ...
        keyboard_page = KeyboardPage(base_data, self.base_data_model, self.test_data)
