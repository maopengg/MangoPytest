# -*- coding: utf-8 -*-
# @Project: 芒果测试平台
# @Description: UI Baidu Fixtures 注册中心
# @Time   : 2026-04-25
# @Author : 毛鹏
"""
UI Baidu 项目的 Fixtures 注册中心
...
使用示例：
    # test_example.py
    from auto_tests.ui_baidu.fixtures.conftest import *
...
# ========== 基础设施 fixtures ==========
from auto_tests.ui_baidu.fixtures.infra.client import (
    driver_object,
)
from auto_tests.ui_baidu.fixtures.infra.base_data import (
    base_data,
)
