...
使用方式:
    from auto_tests.pytest_ui_mock.config import get_config, settings
...
from .settings import PytestUIMockConfig, DevConfig, TestConfig, PreConfig, ProdConfig
...
def _resolve_env() -> str:
    ...
    if env:
        return env.lower()
    from auto_tests.pytest_ui_mock import DEFAULT_ENV
