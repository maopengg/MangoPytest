...
使用示例：
    # test_example.py
    from auto_tests.pytest_ui_mock.fixtures.conftest import *
...
# ========== 基础设施 fixtures ==========
from auto_tests.pytest_ui_mock.fixtures.infra.client import (
    driver_object,
)
from auto_tests.pytest_ui_mock.fixtures.infra.base_data import (
    base_data,
)
