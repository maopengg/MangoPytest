...
class MangoMockUICapabilityBase(SyncWebDevice):
    PAGE_NAVIGATION = {
    ...
    def __init__(
        ...
        *,
        ...
        self.element_model = SimpleNamespace(name=f"{mode_name} data-testid")
    ...
    def goto(self) -> None:
        log.info(f"打开 Mango Mock UI：{self.settings.BASE_URL}")
    ...
    def _expand(self, value: Any) -> Any:
        ...
        replacements = {
            ...
            "${test_run_id}": self.run_name_prefix,
        }
        result = value
