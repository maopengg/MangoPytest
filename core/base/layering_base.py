...
使用示例：
    from auto_tests.api.pytest_api.test_cases import UnitTest, IntegrationTest, E2ETest
...
class TestContext:
    ...
    def create(self, entity_type: Type, **kwargs) -> Any:
        """创建实体"""
        # 延迟导入避免循环依赖
        from auto_tests.api.pytest_api.data_factory.strategies import APIStrategy
