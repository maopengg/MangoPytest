...
from models.tools_model import TestMetrics
from tools import ensure_path_sep
...
class AllureFileClean:
    ...
    def get_testcases(cls) -> List:
        ...
        # 将所有数据都收集到files中
        files = []
        for i in get_all_files(Path.ensure_path_sep("\\report\\html\\modules_api\\test-cases")):
