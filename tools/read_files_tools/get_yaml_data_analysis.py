...
from tools.cache_process.cache_control import CacheHandler
...
if __name__ == '__main__':
    a = CaseData(r'D:\Test_Code\pytest-auto-api2-master\data\Collect\collect_addtool.yaml').case_process()
    print(a)
