...
def data_init():
    ...
    :return:
    """
    data_model: BaiduTranslateModel = ProjectPublicMethods.get_data_model(
        BaiduTranslateModel,
        ProjectEnum.BaiduTranslate.value,
    ...
    log.info(f'{ProjectEnum.BaiduTranslate.value}的API在自动化基础信息设置完成！')
