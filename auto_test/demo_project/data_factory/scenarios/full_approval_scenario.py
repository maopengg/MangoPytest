...
class FullApprovalScenario(BaseScenario):
    ...
    variants = VariantMatrix([
        Dimension("amount", [
            Variant("small", {"amount": 1000, "level": 1, "requires_ceo": False}, 0),
            Variant("medium", {"amount": 50000, "level": 2, "requires_ceo": False}, 1),
            Variant("large", {"amount": 500000, "level": 3, "requires_ceo": True}, 2),
        ]),
        Dimension("urgency", [
        ...
        if amount is None:
            ...
            if self._current_variant:
                ...
                if amount_variant and hasattr(amount_variant, 'values'):
                    ...
                    self.params["requires_ceo"] = amount_variant.values.get("requires_ceo", False)
