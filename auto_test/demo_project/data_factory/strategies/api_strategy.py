...
class APIStrategy(BaseStrategy[T]):
    ...
    def __init__(self, token: Optional[str] = None, context: Optional[Any] = None, config: Optional[Dict] = None):
        """
        初始化API策略
    ...
    def _call_create_api(self, api_module, entity: BaseEntity) -> Dict:
        ...
        payload = entity.to_api_payload() if hasattr(entity, "to_api_payload") else entity.__dict__
    ...
    def _call_update_api(self, api_module, entity: BaseEntity, updates: Dict) -> Dict:
        ...
        method_mapping = {
            "UserEntity": ("update_user", {"user_id": entity_id, **updates}),
            "ReimbursementEntity": ("update_reimbursement", {"reimbursement_id": entity_id, **updates}),
            "ProductEntity": ("update_product_info", {"product_id": entity_id, **updates}),
            "OrderEntity": ("update_order_info", {"order_id": entity_id, **updates}),
        }
    ...
    def _call_delete_api(self, api_module, entity_type: Type, entity_id: Any) -> Dict:
        ...
        method_mapping = {
            ...
            "ReimbursementEntity": ("delete_reimbursement", {"reimbursement_id": entity_id}),
    ...
    def _call_get_api(self, api_module, entity_type: Type, entity_id: Any) -> Dict:
        ...
        method_mapping = {
            ...
            "ReimbursementEntity": ("get_reimbursement_by_id", {"reimbursement_id": entity_id}),
