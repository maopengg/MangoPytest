...
class TestCEOApprovalAPI:
    ...
    def test_get_ceo_approvals(self, api_client, ceo_approved_reimbursement):
        """测试获取总经理审批列表"""
        demo_project.ceo_approval.set_token(api_client.token)
    ...
    def test_get_ceo_approvals_by_reimbursement(self, api_client, ceo_approved_reimbursement):
        """测试根据报销申请ID获取总经理审批"""
        reimbursement_id = ceo_approved_reimbursement["reimbursement"]["id"]

        demo_project.ceo_approval.set_token(api_client.token)
        result = demo_project.ceo_approval.get_ceo_approval_by_id(approval_id=reimbursement_id)
...
class TestCEOApprovalBuilder:
    ...
    def test_builder_get_by_reimbursement(self, ceo_approval_builder, ceo_approved_reimbursement):
        """测试Builder根据报销申请获取审批"""
        reimbursement_id = ceo_approved_reimbursement["reimbursement"]["id"]
