...
from auto_test.ui_baidu import ui_project_data_model
...
from models.ui_model import UiDataModel, UiProjectDataModel
...
class TestOpenSource:
    ...
    def test_01(self, execution_context, data: UiDataModel):
        login_page = HomePage(execution_context, self.data_model, self.test_data)
        login_page.goto()
        login_page.click_open_source()
        open_source_page = OpenSourcePage(execution_context, self.data_model, self.test_data)
