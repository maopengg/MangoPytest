...
VALUES (1, 'testuser', 'test@example.com', 'Test User', '482c811da5d5b4bc6d497ffa98491e38', 'user', 'active', NOW(),
        NOW()),
       (2, 'admin', 'admin@example.com', 'Administrator', '21232f297a57a5a743894a0e4a801fc3', 'admin', 'active', NOW(),
        NOW()),
       (3, 'dept_manager', 'dept@example.com', 'Department Manager', '482c811da5d5b4bc6d497ffa98491e38', 'manager',
        'active', NOW(), NOW()),
       (4, 'finance_manager', 'finance@example.com', 'Finance Manager', '482c811da5d5b4bc6d497ffa98491e38', 'finance',
        'active', NOW(), NOW()),
       (5, 'ceo', 'ceo@example.com', 'CEO', '482c811da5d5b4bc6d497ffa98491e38', 'ceo', 'active', NOW(), NOW()),
       (6, 'zhangsan', 'zhangsan@example.com', '张三', '482c811da5d5b4bc6d497ffa98491e38', 'user', 'active', NOW(),
        NOW()),
       (7, 'lisi', 'lisi@example.com', '李四', '482c811da5d5b4bc6d497ffa98491e38', 'user', 'active', NOW(), NOW()),
       (8, 'wangwu', 'wangwu@example.com', '王五', '482c811da5d5b4bc6d497ffa98491e38', 'user', 'inactive', NOW(),
        NOW());

-- 初始化产品数据
INSERT INTO products (name, price, description, stock, category, status, created_at, updated_at)
VALUES ('笔记本电脑', 5999.00, '高性能商务笔记本，Intel i7处理器，16GB内存，512GB SSD', 100, 'electronics', 'active',
        NOW(), NOW()),
