...
| **BaseFactory** | `core/base/baseFactory.py` | `bdd_api/data_factory/specs/` | 🔥 高频 |
| **BaseBuilder** | `core/base/base_builder.py` | `pytest_api/data_factory/builders/` | 🔥 高频 |
| **BaseEntity** | `core/base/base_entity.py` | `pytest_api/data_factory/entities/` | 🔥 高频 |
| **PydanticEntity** | `core/base/pydantic_base.py` | `pytest_api/data_factory/entities/` | 🔥 高频 |
| **PydanticBuilder** | `core/base/pydantic_builder.py` | `pytest_api/data_factory/builders/` | 🔥 高频 |
| **BuilderContext** | `core/base/builder_context.py` | `pytest_api/data_factory/context.py` | 🔥 高频 |
| **BaseStrategy** | `core/base/base_strategy.py` | `pytest_api/data_factory/strategies/` | 🔥 高频 |
| **StrategyResult** | `core/base/strategy_result.py` | `pytest_api/data_factory/strategies/` | 🔥 高频 |
| **BaseRepository** | `core/base/repository_base.py` | `bdd_api/repos/` | 🔥 高频 |
...
#### BaseFactory
```python
# 使用示例（bdd_api/data_factory/specs/user/user_spec.py）
...
#### BaseBuilder
```python
# 使用示例（pytest_api/data_factory/builders/user/user_builder.py）
...
#### PydanticEntity
```python
# 使用示例（pytest_api/data_factory/entities/user_pydantic.py）
...
| 名称 | 文件路径 | 使用位置 | 说明 |
|------|---------|---------|------|
| **APIClient** | `core/api/client.py` | `simple_api/abstract/`, `bdd_api/` | HTTP 客户端 |
...
| 类名 | 文件路径 | 使用位置 | 使用频率 |
|------|---------|---------|---------|
| **WebBaseObject** | `core/ui/web_base.py` | `bdd_ui/page_object/`, `pytest_ui/page_object/` | 🔥 高频 |

### 4.2 使用示例

```python
# 使用示例（bdd_ui/page_object/home.py）
